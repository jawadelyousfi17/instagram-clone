...
import { FormattedProfile } from "../page";
import { posts, stories } from "@/data";

const HomePage = ({ profile }: { profile: FormattedProfile }) => {
    ...
    <div className="h-screen flex flex-col overflow-hidden">
      ...
      <div ref={scrollRef} className="flex-1 overflow-y-auto">
        ...
        >
          <div className="flex justify-between p-4">
            ...
            <div className="relative">
              <div className="w-2.5 h-2.5 border-2 border-white rounded-full absolute top-0 right-[-3px] bg-red-500"></div>
              <svg
        ...
        <div className="flex gap-2 px-1 overflow-hidden">
          <MyStory username="Your story" imageUrl={proxyUrl} />
          {stories.map((story, index) => (
            <Story imageUrl={story.image} username={story.username} />
          ))}
        </div>
