    ...
    <div className="flex flex-col px-4 py-4">
      ...
      <div className="flex flex-col justify-between mt-8">
        <div className="flex flex-col gap-14">
          <div className="flex justify-center items-center text-foreground/60 text-sm">
            English (US) <ChevronDown strokeWidth={1.5} size={18} />
          </div>

          <div className="flex justify-center items-center">
            <img src="/icons/instagram.png" className="h-14" />
          </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <Button
              className="rounded-full h-10 bg-[#0046f6]"
              onClick={handleLogIn}
            >
              {loading ? <span className="loader"></span> : <>Log in</>}
            </Button>
            <div className="text-foreground/95 text-center mt-2">
              Forgot password?
            </div>
          </div>
        </div>
        <div className="space-y-4 absolute bottom-8 left-0 w-full px-4">
          <Button
            disabled={loading}
            className="rounded-full w-full h-10 bg-transparent text-[#0046f6] border border-[#0046f6]"
          >
            {" "}
            Create new account
          </Button>
