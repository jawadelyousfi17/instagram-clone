import { FormattedProfile } from "@/app/home/page";
...
const Navbar = ({
  ...
  return (
    <div className="flex-none fixed bottom-0 left-0 w-full flex justify-between p-4 bg-background border-t border-border/50 z-49">
      ...
      <div onClick={() => setActive("profile")}>
        <img
          ...
          className={cn(
            "rounded-full -mt-1.5",
            active === "profile" && "border-foreground/95 border-2",
          )}
        />
      </div>
    </div>
